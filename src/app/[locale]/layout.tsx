...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    title: { default: "Loot to Forge Wiki", template: "%s" },
    description: "Complete Loot to Forge fan wiki with working codes, forging and crafting guides, item and weapon lists, dungeon tips and rebirth progression walkthroughs.",
