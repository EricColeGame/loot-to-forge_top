    ...
    <div className="flex items-center justify-between gap-4">
      <Link href={localizeHref("/", locale)} className="flex items-center gap-3">
        <div className="grid h-9 w-9 place-items-center rounded-xl border border-border bg-[hsl(var(--nav-theme))] shadow-sm">
          <span className="text-sm font-black tracking-tight text-primary-foreground" aria-hidden="true">{siteConfig.logoText}</span>
        </div>
    ...
    <div className="group relative cursor-pointer overflow-hidden rounded-2xl border border-border shadow-lg transition-all duration-200">
      <div className="relative aspect-video w-full">
        <img
          ...
          alt={`${siteConfig.name} gameplay trailer preview`}
